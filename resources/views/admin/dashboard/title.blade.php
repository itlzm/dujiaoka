    ...
    <div class="card-body">
        <div class="text-center ">
            ...
            <div class="text-center mb-1">
                <h1 class="mb-3 mt-2 text-white">{{ config('dujiaoka.dujiaoka_name', 'CVKData') }} V{{ config('dujiaoka.dujiaoka_version', '2.0.0') }}</h1>
                <div class="links">
...
<!--                    </a>-->
                    <a href="http://t.me/{{ config('dujiaoka.telegram_group_name', 'cvkdata') }}" id="telegram-group-link" target="_blank">{{ __('dujiaoka.join_telegram_group') }}</a>
